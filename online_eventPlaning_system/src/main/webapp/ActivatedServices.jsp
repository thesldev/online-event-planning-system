...
<head>
    ...
    <title>activated_services_UI</title>
    <link rel="stylesheet" href="asserts_activated_services/assets/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="asserts_activated_services/assets/fonts/font-awesome.min.css">
    <link rel="stylesheet" href="asserts_activated_services/assets/css/animate.min.css">
    <link rel="stylesheet" href="asserts_activated_services/assets/css/Pretty-Product-List-.css">
    <link rel="stylesheet" href="asserts_activated_services/assets/styles.css">
</head>
...
<body>
    ...
    String query = "SELECT * FROM servicetable WHERE uid=" + uid;
...
%> 
    ...
    <div class="services-container">
        <div class="service">
            <div class="img-box">
                <img src="service2.jpg" alt="img_service">
            </div>
          ...
          <button class="edit-btn" type="button" onclick="location.href='update_activated_services.jsp?sid=<%=serviceId%>';">Edit</button>
          <button class="delete-btn" type="button"  onclick="location.href='DeleteService.jsp?sid=<%=serviceId%>';">Delete</button>
