...
<head>
    ...
    <title>Account_profile</title>
    <link rel="stylesheet" href="asserts_seller_profile/assets/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="asserts_seller_profile/assets/css/animate.min.css">
    <link rel="stylesheet" href="asserts_seller_profile/assets/style2.css">
</head>
...
<body>
    ...
    String email = null;
    String firestName = null;
    String lastName = null;
    int Id = 0;
    
    String query = "SELECT * FROM registeredseller WHERE id=" + uid;
    ...
    while (rs.next()) {
        ...
        firestName = rs.getString("firest_name");
...
%>
    ...
    <div class="page-content">
        <div class="seller-card">
            <div class="seller-picture">
                <img src="assets/img/seller_profile.jpg" alt="Seller Picture">
            </div>
            <div class="seller-info">
                <h2><%=userName%></h2>
                <p>User ID Number: <%=Id%></p>
                <p>Email: <%=email%></p>
                <p>Firest Name: <%=firestName%></p>
    ...
    <footer class="text-white bg-dark" style="margin-top: 288px;">
