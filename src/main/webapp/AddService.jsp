...
<body style="background: rgb(188,188,188);">
    ...
    <div class="html-form">
        ...
        <div onsubmit="return validateForm()">
            ...
            <textarea id="service_description" name="service_description" placeholder="Enter service description" required></textarea>
            
            <label for="service_price">Service Price:</label>
            <input type="number" id="service_price" name="service_price" placeholder="Enter service price" required>
            
            <!-- <label for="service_images">Service Images:</label>
    ...
    <script>
        function validateForm() {
          ...
          if (service_name == "" || service_description == "" || service_price == "" || contact_number == "" || service_type == "") {
    ...
    <footer class="text-white bg-dark" style="margin-top: 65px;">
